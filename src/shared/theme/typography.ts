...
export const fontFamily = {
  ...
  // mono 는 Things 3 디자인에 없음. 구 Linear 호환용으로 값만 남김.
  mono: 'Menlo',
  // 구 Linear 호환 shim (medium 참조하는 기존 코드가 있을 경우)
...
export const typography = {
  ...
  // ── 하위 호환 shim (C 에이전트가 구 토큰 이름 참조 시) ───────────
  /** @deprecated → taskTitle 사용 */
  issueTitle: {
    fontFamily: fontFamily.regular,
    fontWeight: '400' as const,
    fontSize: 17,
  ...
  /** @deprecated → metadata 사용 (mono 제거됨) */
  monoId: {
